      ...
      <div className="flex flex-col md:flex-row rounded-[37px] md:rounded-[37px] overflow-hidden shadow-2xl bg-white w-full max-w-[1108px] max-h-[90vh] md:h-[625px]">
        ...
        <div className="relative w-full md:w-1/2 bg-white text-gray-900 p-6 md:p-12 flex items-center justify-center overflow-y-auto">
          ...
          <div className="w-full max-w-md mx-auto">
            <h2 className="text-xl md:text-2xl font-semibold mb-4 text-center text-gray-900">Create Password</h2>

            <div className="space-y-6">
              <div className="relative">
                <label className="absolute -top-3 left-4 bg-white px-1 text-sm text-gray-600">Enter password</label>
                <input
                  type="password"
                  value={password}
              ...
              <div className="relative">
                <label className="absolute -top-3 left-4 bg-white px-1 text-sm text-gray-600">Confirm password</label>
                <input
                  type="password"
              ...
              <div className="flex justify-start mt-6 md:mt-12">
                <button
                  ...
                  className="inline-flex items-center text-gray-600 px-4 py-2 border border-gray-300 rounded-full hover:border-gray-500 hover:text-gray-900"
                >
