  ...
  return (
    <section className="flex flex-col gap-4 justify-between items-start px-2 sm:px-4 md:px-6 w-full md:w-11/12 lg:w-8/12 max-md:items-center">
      <header className="flex flex-col gap-4 items-start w-full">
        <div className='w-fit'>
          <h1 className="text-[40px] font-bold leading-10 text-[#9411a8] max-md:text-3xl max-md:leading-8 max-sm:text-3xl max-sm:leading-7">
            Get in Touch
          </h1>
          <div className=' h-[2px] bg-[#9411a8] '></div>
        </div>
      </header>

      <section className="flex flex-col gap-4 items-start w-full">
        <h2 className="text-3xl font-semibold text-gray-900 max-md:text-2xl max-sm:text-xl">
          How to contact us
        </h2>
        <div className="flex flex-col gap-2.5 items-start w-full text-gray-900">
          ...
          <div className="flex flex-col w-full">
            ...
            <span className="ml-8 text-base underline underline-offset-2 decoration-[1.1px] decoration-[#9411a8] text-gray-600 max-sm:text-sm">edubraining@gmail.com</span>
          </div>
        </div>
      </section>

      {/* We're here part below How to contact us */}
      <div className="w-full pr-0 md:pr-8 text-gray-500 my-0 text-[13px] leading-[18px] max-sm:text-xs ">
      ...
      <section className="flex flex-col gap-2.5 items-start w-full">
        <h3 className="text-sm font-bold leading-4 text-gray-900">
          Why Contact Us?
        </h3>
        <ul className="list-disc ml-2 text-sm text-gray-600 max-sm:text-xs">
      ...
      <section className="flex flex-col gap-1.5 items-start w-full">
        <h3 className="text-sm font-bold text-gray-900 max-sm:text-sm">
