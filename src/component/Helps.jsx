...
const CertificationAchievement = () => {
  const benefits = [
    {
      icon: (
        <svg className="w-8 h-8 text-[#9411a8]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="relative bg-gray-50 text-gray-900 min-h-screen py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          <p className="text-[#9411a8] text-sm sm:text-base lg:text-lg mb-4 sm:mb-6 font-medium tracking-wide uppercase">
          ...
          <p className="text-gray-600 text-sm sm:text-base lg:text-lg leading-relaxed max-w-4xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {benefits.map((benefit, index) => (
            <div
              key={index}
              className="bg-white border border-gray-100 rounded-xl sm:rounded-2xl p-6 sm:p-8 text-center hover:border-[#9411a8]/30 transition-all duration-300 hover:transform hover:scale-105 hover:shadow-xl hover:shadow-[#9411a8]/5 group"
            >
              {/* Icon */}
              <div className="flex justify-center mb-4 sm:mb-6">
                <div className="p-3 sm:p-4 bg-[#9411a8]/10 rounded-xl sm:rounded-2xl group-hover:bg-[#9411a8]/20 transition-colors duration-300">
                  {benefit.icon}
                </div>
              </div>

              {/* Title */}
              <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-gray-900 group-hover:text-[#9411a8] transition-colors duration-300">
                {benefit.title}
              </h3>
