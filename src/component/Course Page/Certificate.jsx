...
export const Certificate = () => {
  ...
  return (
    <div className="w-full mx-auto relative overflow-x-hidden">
      ...
      <main className="relative w-full max-w-[1424.64px] mx-auto min-h-[600px] lg:h-[922px] bg-gray-50 overflow-visible px-2 lg:px-0">
        <section className="relative min-h-[500px] lg:h-[742px] top-0 lg:top-[73px] flex flex-col justify-center z-20">
          ...
          <div className="flex flex-col items-center gap-10 lg:gap-[81.85px] relative lg:absolute lg:top-[33px] lg:left-[108px] top-0 left-0 w-full px-2 lg:px-0 z-20">
            <header className="flex flex-col w-full lg:w-[822.57px] items-center gap-2 lg:gap-[8.18px] relative flex-[0_0_auto]">
              <h1 className="relative w-fit mt-0 lg:mt-[-0.82px] lg:ml-[-77.72px] lg:mr-[-77.72px] font-semibold text-[#9411a8] text-2xl lg:text-5xl text-center tracking-[0] leading-9 lg:leading-[65.5px] whitespace-normal">
                Earn an Industry-Recognized Certification
              </h1>
              <p className="self-stretch font-medium text-gray-500 text-center leading-6 lg:leading-[24.6px] relative text-base lg:text-[24.6px] tracking-[0]">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-[45px] w-full justify-center">
              ...
              <div className="flex flex-col items-start gap-4 lg:gap-[22.03px] w-full max-w-[600px]">
                <p className="w-full lg:w-[600px] mt-0 lg:mt-[-1.60px] font-semibold text-gray-900 leading-6 lg:leading-[31.1px] text-base lg:text-[24.6px] tracking-[0]">
                  ...
                  {features.map((feature, index) => (
                    ...
                    >
                      <div className="flex flex-row items-center gap-2 lg:gap-[8.02px] w-full">
                        ...
                        <h3 className="font-semibold   text-gray-900 text-base lg:text-[20.5px] tracking-[0] leading-6 lg:leading-[43.3px] whitespace-normal">
                          {feature.title}
                        </h3>
                      </div>

                      <p className="font-normal text-gray-500 text-sm lg:text-[20.5px]  tracking-[0] leading-5 lg:leading-[20.5px] whitespace-normal">
                        {feature.description}
                      </p>
                    </li>
                  ))}
            ...
            <div className="flex flex-row flex-wrap items-center gap-4 lg:gap-[26px] w-full justify-center">
              <button className="inline-flex items-center justify-center gap-3 lg:gap-[13px] px-4 lg:px-[25px] py-3 bg-[#9411a8] rounded-[10px] hover:bg-[#7a0e8a] focus:outline-none focus:ring-2 focus:ring-[#9411a8] focus:ring-offset-2 focus:ring-offset-white transition-colors">
                <span className="font-medium text-white text-base tracking-[0] leading-6 whitespace-nowrap">
                  Start Your Certification Journey
                </span>
              </button>

              <button className="inline-flex items-center justify-center gap-3 lg:gap-[13px] px-4 lg:px-5 py-3 rounded-[10px] border border-solid border-[#9411a8] hover:bg-[#9411a8]/5 text-[#9411a8] focus:outline-none focus:ring-2 focus:ring-[#9411a8] focus:ring-offset-2 focus:ring-offset-white transition-colors">
