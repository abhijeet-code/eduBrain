    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center px-2 md:px-0">
        <header className="flex flex-col items-center gap-5 mb-10">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#9411a8] text-center leading-tight">
          ...
          <div className="w-full flex flex-col gap-4 items-center">
            <p
              className="font-montserrat text-base sm:text-lg md:text-[20px] leading-[22px] md:leading-[25px] font-medium text-gray-900 w-full max-w-4xl text-center"
            >
            ...
            <p
              className="font-montserrat text-sm sm:text-base md:text-[18px] leading-[20px] md:leading-[25px] font-medium text-gray-500 w-full max-w-4xl text-center"
            >
        ...
        <section className="flex flex-col lg:flex-row items-center gap-10 w-full mx-auto px-0 md:px-4">
          ...
          <aside className="flex flex-col w-full max-w-xl items-start gap-8 px-2 md:px-5 mt-8 md:mt-0">
            <h2 className="text-gray-900 text-xl sm:text-2xl md:text-3xl font-bold mb-2">
              Top Benefits
            </h2>
            <div className="flex flex-col gap-6 w-full mx-auto leading-5">
              {benefitsData.map((benefit) => (
                <article
                  key={benefit.id}
                  className="flex items-center gap-3 md:gap-4 px-3 md:px-5 py-3 md:py-4 bg-white rounded-xl border border-gray-100 w-full md:w-[80%]"
                >
                  <img
