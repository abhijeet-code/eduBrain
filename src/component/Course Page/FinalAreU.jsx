      ...
      <section className="flex flex-col gap-9 items-center px-4 md:px-5 py-12 md:py-20  w-full">
        ...
        <div className="flex flex-col gap-3.5 items-center w-full">
          <div className="flex flex-row gap-4 sm:gap-7 items-center w-full max-w-[400px] justify-center ">
            <Link
              to={`/billing?course=${course._id}`} className="flex gap-3.5 justify-center items-center px-6 py-3 bg-[#9411a8] rounded-xl w-fit min-w-fit max-w-[180px] hover:bg-[#7a0e8a] transition-colors">
              <span className="text-base font-medium leading-6 text-white">Enroll Now</span>
            </Link>
            <button
